...
namespace molcpp
{
    ...
    bool ForceField::match_atom(Atom* atom)
    {
        std::string atomtype_name = atom->get<std::string>("type");
        auto atomtype = get_atomtype(atomtype_name);
    ...
    bool ForceField::match_bond(Bond* bond)
    {
