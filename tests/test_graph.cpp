...
namespace molcpp
{
    ...
    public:
        Atom() : _node{} {}
        void add_bond(std::shared_ptr<Bond> BondPtr) { _node.add_edge(BondPtr); }
        ~Atom() = default;

    private:
        TGraph<std::shared_ptr<Atom>, std::shared_ptr<Bond>, std::shared_ptr<Mol>>::TNode _node;
    };
    ...
    private:
        TGraph<std::shared_ptr<Atom>, std::shared_ptr<Bond>, std::shared_ptr<Mol>>::TEdge _edge;
    };
    class Mol
    {
    public:
    ...
    private:
        TGraph<std::shared_ptr<Atom>, std::shared_ptr<Bond>, std::shared_ptr<Mol>> _graph;
    };
